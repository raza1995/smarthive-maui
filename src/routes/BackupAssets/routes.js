...
import { BackupAssetsOverview, getBackupAssets } from "../../Mysql/AssetBackupInformation/assetBackupInformation.controller";
import ASSET_URL from "./urlConstant";

const backupAssetRouter = Router();

/**
 * @swagger
 * /backup/assets:
 *   get:
 *     summary: Returns list of backup assets
 *     tags: ["Assets"]
 *     security:
 *      - BearerAuth: []
 *     parameters:
...
backupAssetRouter.get(
  ASSET_URL.ASSETS_OVERVIEW.URL,
  [
    userAuth,
    checkPermission(
      ASSET_URL.ASSETS_OVERVIEW.SLUG,
      ASSET_URL.ASSETS_OVERVIEW.ACTION
    ),
  ],
  BackupAssetsOverview
);

export default backupAssetRouter;
